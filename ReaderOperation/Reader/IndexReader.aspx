...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid" >
        <div class="row" style="background: url(images/reader.jpg) no-repeat; height: 650px;">
            <div class="col-lg-12" style="background-color:rgba(0, 0, 0, 0.50);height:inherit" >
                ...
                <div class="col-sm-4 text-center">
                    ...
                    <div style="padding: 10px 0; font-weight: bold">
                        <p style="color:#ffffff;font-size:23px;">find book</p>
                ...
                <div class="col-sm-4 text-center">
                    ...
                    <div style="padding: 10px 0; font-weight: bold">
                        <p style="color:#ffffff;font-size:23px;">look up Borrowed list</p>
                    </div>
                </div>
                <div class="col-sm-4 text-center">
                    <div>
                    ...
                    <div style="padding: 10px 0; font-weight: bold">
                        <p style="color:#ffffff;font-size:23px;">Modify personal information</p>
                    </div>
                </div>
            </div>
        </div>
